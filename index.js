...
console.log(getArtistByIndex(artists[1],2));
...
function get20s(artists){
  ...
  if(artists.years > 1889 && artists['years']<2001){
    return artists;
  }
}
...
function addArtist(array,id,name,years,genre,nationality,bio){
  ...
  console.log(addArtist(artists,'brandon','1993-2021','Web Design','American','My name is Brandon. I love to code'));
...
function lotsOfArt(paintings){
  paintings = artists.keys;
console.log([...artists])


  for (let i = 0; i < artists.length; i++)
  if(artists.paintings > 100){
    return paintings.name;
}
}
